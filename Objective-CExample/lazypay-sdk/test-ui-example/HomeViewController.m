...
//    self.mobileTextField.text = @"7720043019";
//    self.emailTextField.text = @"mukeshcitrus122@mailinator.com";
//    self.amountTextField.text = @"1.00";
}
